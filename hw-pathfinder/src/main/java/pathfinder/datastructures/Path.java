...
/**
 * This represents an immutable path between valued represented by generic type T,
...
public class Path<T> implements Iterable<Path<T>.Segment> {
    ...
    /**
     * Appends a new single segment to the end of this path, originating at the current last T value
     ...
     * segmentCost}.
     *
     * @param newEnd      The T value being added at the end of the segment being appended to this path
    ...
    /**
     * Segment represents a single segment as part of a longer, more complex path between T values.
    ...
    public class Segment {
         ...
         *
         * @param start The starting T value of this segment.
         * @param end   The ending T value of this segment.
         * @param cost  The cost of travelling this segment.
         * @throws NullPointerException     if either T value is null.
