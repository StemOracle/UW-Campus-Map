...
public class TaskSorter {
    ...
    // Graph of Tasks and Dependencys
    private Graph<Task, Dependency> planner;

    /**
     * Creates a new TaskSorter object with no added tasks or dependencies.
     */
    public TaskSorter() {
        this.planner = new Graph<Task, Dependency>();
    }
	...
	tasks.addAll(this.planner.listNodes());
	return tasks;
    }
	...
	this.planner.addEdge(before, after, dep);
    }
